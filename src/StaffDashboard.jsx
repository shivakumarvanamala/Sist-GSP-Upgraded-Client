...
const StaffDashboard = () => {
  ...
  return (
    <div className="relative">
      ...
      <main
        className="max-w-7xl px-4 mx-auto grid place-items-center grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 pb-8"
...
//       <footer
//         className="absolute bottom-0 left-0 w-full h-8 flex items-center justify-center text-black bg-slate-100"
//         onClick={() => setOpen(false)}
//       >
//         <b>&copy;</b>&nbsp;
